    ...
    var obj = {
        trackLibraryManagement: function(componentName) {
            ...
            $.each(getRoot, function(key, listId) {
                ...
                // 	url: config_constant.URL_HEADER,
                // 	// data: JSON.stringify({
                // 	//     id : editerGetId
                // 	// }),
                ...
                map.on('load', function() {
                     ...
                     * @param width 图层线条width
                     */
                    function createHisMarkerData(id, src, color, width, filter) {
                        map.addLayer({
                            'id': id,
                            'type': 'line',
                            'source': {
                    ...
                    // createHisMarkerData("testGeoJsonHover", '/HDWeb/json/test.json', "#fff", 4, );
                    map.addLayer({
                        'id': "testGeoJsonHover",
                        'type': 'line',
                        'source': {
                            'type': 'geojson',
                            'data': '/HDWeb/json/test.json'
                        },
                        "layout": {
                            "line-join": "round",
                            /* 线条相交的形状 */
                    ...
                    map.on('mousemove', 'testGeoJson', function(e) {
                        ...
                        var relatedFeatures = map.querySourceFeatures('testGeoJson', {
