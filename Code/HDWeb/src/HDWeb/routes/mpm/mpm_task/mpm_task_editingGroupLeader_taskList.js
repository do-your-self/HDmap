 ...
 * Author: 付国强
 * instructions:高精度地图在线生产管理平台任务管理编辑组长任务单页面配置文件
 */
layui.define(['header','nonavigationBody','panelCrumbs','taskBasicInformation','editorTaskTableList'], function (exports) {
    var obj = function (componentName) {
      ...
      layui.editorTaskTableList.editorTaskTableList(componentName);
    }
    exports('mpm_task_editingGroupLeader_taskList', obj);
  });