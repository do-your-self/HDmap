 ...
 * Author: 付国强
 * instructions:高精度地图在线生产管理平台任务管理质检组长任务单页面配置文件
 */
layui.define(['header','nonavigationBody','panelCrumbs','taskBasicInformation','button','qcTaskTableListView'], function (exports) {
    var obj = function (componentName) {
      ...
      layui.qcTaskTableListView.qcTaskTableListView(componentName);
    }
      exports('mpm_task_qcLead_viewTaskList', obj);
    });