 ...
 * Author: 付国强
 * instructions:采集管理员采集需求管理
 */
layui.define(['header','nonavigationBody','panelCrumbs','tableList','button'],function (exports) {
    ...
    exports('mpm_collectionAndManagement_collectionManagerCollectionRequirementsManagement', obj);
  });