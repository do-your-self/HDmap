 ...
 * Author: 付国强
 * instructions:高精度地图在线生产管理平台任务管理质检组长任务正在进行中配置文件
 */
layui.define(['config_constant'], function (exports) {
            ...
            children: [{
                    ...
                    body: [{
                        ...
                        components: [{
                                ...
                                addButton: [{
                                    buttonName: '搜索',
                                    url: config_constant.URL_HEADER + 's/taskstatus/find',
                                    type: 'SearchData',
                                    listConfig: [{
                                        title: "搜索",
                                        submitkey: "search",
                                    ...
                                    cols: [
                                        [ //表头
                                            ...
                                            , {
                                                ...
                                                align: 'center',
                                                templet: '<div>' +
                                                    '<a class="layui-btn layui-btn-primary tableList_btnsize tableList_Tasklist" href="' + config_constant.HREF_HEADER + 'TaskManagementNav/QCLeadTaskLoading/QCLeaderTaskList">任务单</a>' +
                                                    // '<a class="layui-btn layui-btn-primary tableList_btnsize tableList_Viewtask" href="javascript:void(0);">查看任务</a>'+
                                                    '</div>'
                                            }
                                        ]
                                    ],
                    ...
                    children: [{
                        title: '任务单',
                        name: 'QCLeaderTaskList',
                        href: config_constant.HREF_HEADER + 'TaskManagementNav/QCLeadTaskLoading/QCLeaderTaskList',
    ...
    exports('mpm_config_task_qcLead_taskLoading', obj);
});