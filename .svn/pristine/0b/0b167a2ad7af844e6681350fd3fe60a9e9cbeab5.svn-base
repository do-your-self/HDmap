 ...
 * Author: 付国强
 * instructions:无左侧导航栏的body组件
 */
layui.link('./script/nonavigationBody/nonavigationBody.css')
layui.define(['layer', 'element', 'form', 'qRouter', 'table'], function (exports) {
	...
	var obj = {
		nonavigationBody: function (componentName) {
			var getRoot = $("#render-nonavigationBody")
			var nodeHtml = '';
