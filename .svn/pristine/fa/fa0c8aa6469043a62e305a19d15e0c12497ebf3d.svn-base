 ...
 * Author: 付国强
 * instructions:高精度地图在线生产管理平台人员编辑组长管理页面配置文件
 */
layui.define(['header','navigation','body','tableList','panelCrumbs','search'], function (exports) {
    var obj = function (componentName) {
      ...
      layui.search.search(componentName);
      layui.tableList.tableList(componentName);
    }
    exports('mpm_personnel_editingGroupLeader', obj);
  });