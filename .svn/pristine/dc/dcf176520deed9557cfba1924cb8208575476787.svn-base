 ...
 * Author: 付国强
 * instructions:高精度地图在线生产管理平台任务管理质检组长任务已完成配置文件
 */
layui.define(['config_constant'], function (exports) {
        ...
        containt: [{
            ...
            children: [{
                                    ...
                                    cols: [
                                        [ //表头
                                            ...
                                            , {
                                                ...
                                                align: 'center',
                                                templet: '<div>' +
                                                    '<a class="layui-btn layui-btn-primary tableList_btnsize tableList_Tasklist" href="' + config_constant.HREF_HEADER + 'TaskManagementNav/QCLeadTaskCompleted/QCLeaderTaskList">任务单</a>' +
                    ...
                    children: [{
                        ...
                        href: config_constant.HREF_HEADER + 'TaskManagementNav/QCLeadTaskCompleted/QCLeaderTaskList',
    ...
    exports('mpm_config_task_qcLead_taskCompleted', obj);
});