...
layui.define(['layer', 'element', 'form', 'qRouter', 'table', 'laytpl', 'config_constant', 'taskBasicInformation'], function (exports) {
    ...
    var obj = {
        editorTaskTableListView: function (componentName) {
            var getRoot = $("[id^='render-editorTaskTableListView']");
    ...
    exports('editorTaskTableListView', obj);
});