 ...
 * Author: 付国强
 * instructions:高精度地图在线生产管理平台系统管理 制作项维护页面配置文件
 */
layui.define(['header','navigation','body','panelCrumbs', 'tableList'], function (exports) {
    ...
    exports('mpm_system_system_makeMaintenance', obj);
  });